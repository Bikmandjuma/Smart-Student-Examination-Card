  ...
  <div class="row">
    ...
    <div class="col-md-8 text-center">
        ...
        <?php
            ...
            echo '<img src="'.$image.'" class="w3-margin-right w3-circle" style="float: center; width:300px;height:300px;border:2px solid skyblue;" title="Click to add profile picture !">';
          
        ?>

        <form method="POST" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>">
            <label><b>Edit profile picture</b></label>
              ...
              if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if(isset($_POST["SubmitAdminProfPicture"])) {
                    ...
                    // if everything is ok, try to upload file
                        ...
                        if ($result) {
                            echo "<script>window.location.assign('ProfilePicture.php');</script>";
