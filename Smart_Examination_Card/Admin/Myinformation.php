...
<!DOCTYPE html>
<html>
<title><?php echo $_SESSION['respons'];?>'s information </title>
<meta charset="UTF-8">
...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left secs_Sidebar list-group secs_nav_list" style="z-index:3;width:305px;" id="secs_mySidebar"><br>
  ...
  <div class="w3-bar-block" style="font-size:20px;" >
    ...
    <span onclick="myFunction('link1')" class="w3-block w3-padding dropdown-toggle list-group-item secs_main_links"><i class="fa fa-graduation-cap"></i>&nbsp;Students</span>
    ...
    <span onclick="myFunction('account')" class="w3-block w3-padding dropdown-toggle list-group-item secs_main_links w3-hover-black active"><i class="fa fa-user-o fa-fw"></i>&nbsp;My account</span>
  ...
  <div class="row">
    <div class="col-md-2">
      <?php
        ...
        if ($image == false) {
            echo '<a href="ProfilePicture.php" class="w3-margin-right w3-circle" title="Click to add profile picture !"><img src="../images/user.png" style="float: center; width:150px;height:150px;border-radius:50%;border:1px solid #aaa;"></a>';
        }else{
            echo '<a href="ProfilePicture.php" title="Click to add profile picture !"><img src="'.$image.'" class="w3-margin-right w3-circle" style="float: center; width:150px;height:150px;border:2px solid skyblue;"></a>';
        }
      ?>
    </div>
    <div class="col-md-10">
    	<?php $Admin->Admin_information();?>
    </div>
  </div>
  <!-- End page content -->
</div>
