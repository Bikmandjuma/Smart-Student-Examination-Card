...
<!DOCTYPE html>
<html>
<title>Exam attendance list</title>
<meta charset="UTF-8">
...
<!-- Top container -->
<div class="row w3-bar w3-top w3-blue w3-large" style="z-index:4">
  <div class="col-md-12">
...
<script type="text/javascript">
      ...
      function showUser(str) {
        if (str == "") {
          ...
          xmlhttp.open("GET","TestAttendanceReadTagData.php?id="+str,true);
          xmlhttp.send();
        }
      }
