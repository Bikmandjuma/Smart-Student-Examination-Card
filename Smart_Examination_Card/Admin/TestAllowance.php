...
<body class="w3-light-grey" onkeypress="//setDelayForReload()">
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="row">
    ...
    <div class="w3-blue">
      <h3 align="center" id="blink"><b>Please Scan card to check if student is allowed to do examination or not !</b></h3>
    </div>
    ...
    function myFunction(id) {
      ...
      function showUser(str) {
        if (str == "") {
          ...
          xmlhttp.open("GET","ReadTagStudentData.php?id="+str,true);
          xmlhttp.send();
        }
      }
